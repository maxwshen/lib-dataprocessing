...
# Default params
inp_place = _config.OUT_PLACE + 'c_alignment_PAMvar/'
...
def gen_qsubs():
  ...
  # Save commands
  commands_fn = qsubs_dir + '_commands_c6_PAMvar.sh'
...
def main(nm = '', start = '', end = ''):
  ...
  # Adjusted for PAMvar library on 02/20/19
  global expected_cutsite
  expected_cutsite = len('GATGGGTGCGACGCGTCAT') + 30
