...
# Default params
inp_place = _config.OUT_PLACE + 'c_alignment_12kChar/'
...
def gen_qsubs():
  ...
  # Save commands
  commands_fn = qsubs_dir + '_commands_c6_12kChar.sh'
...
def main(nm = '', start = '', end = ''):
  ...
  global expected_cutsite
  expected_cutsite = len('GATGGGTGCGACGCGTCAT') + 39
