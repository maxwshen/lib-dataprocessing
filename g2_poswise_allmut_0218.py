...
# Functions
##
def poswise_allmutations(nm, inp_place, lib_design, lib_nm):
  dd = defaultdict(list)
    ...
    for i, line in enumerate(f):
      ...
      if i % 4 == 2:
        ...
        for idx in range(start_pos, end_pos):
          ...
          d[pos_nm][ref_nt][obs_nt] += ulmi_count
...
def main(nm = ''):
  ...
  poswise_allmutations(nm, inp_dir, lib_design, lib_nm)
